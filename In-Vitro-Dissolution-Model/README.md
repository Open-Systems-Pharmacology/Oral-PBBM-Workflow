...
* `pH`: pH of the of dissolution medium. Table 1 below lists pH of commonly used biorelevant media.
...
* `BS_Concentration`: Molar concentration of bile salts or surfactants present in the dissolution medium. Table 1 below lists molar concentrations of bile salts in commonly used biorelevant media.
...
**Table 2: Diffusion coefficient of bile salt/lecithin micelles in biorelevant media calculated using the Stokes-Einstein-Sutherland equation**
...
| --------- | ---------------- | --------------- | ---------------------------- | --------------------------- | ----------------------------------------- | ------------------------------------------------- |
| FaSSIF-V1 | 37 | Taurocholic acid/egg lecithin | 3.0                          | 0.75                        | 54.4 (Okazaki et al. [[3](#References)])  | 1.220 * 10<sup>-7</sup> |
| FaSSIF-V1 | 37 | Sodium taurocholate/lecithin  | 3.0                          | 0.75                        | 61.5 (biorelevant.com [[4](#References)]) | 1.079 * 10<sup>-7</sup> |
| FaSSIF-V2 | 25 | Sodium taurocholate/lecithin  | 3.0                          | 0.2                         | 20.8 (Pepin et al. [[5](#References)])    | 3.190 * 10<sup>-7</sup> |
| FeSSIF-V1 | 37 | Taurocholic acid/egg lecithin | 15                           | 3.75                        | 6.3 (Okazaki et al. [[3](#References)])   | 1.053 * 10<sup>-6</sup> |
| FeSSIF-V1 | 37 | Sodium taurocholate/lecithin  | 15                           | 3.75                        | 5.9 (biorelevant.com [[4](#References)])  | 1.125 * 10<sup>-6</sup> |
| FeSSIF-V1 | 25 | Sodium taurocholate/lecithin  | 15                           | 3.75                        | 6.0 (Pepin et al. [[5](#References)])     | 1.106 * 10<sup>-6</sup> |


**Table 3: Diffusion coefficients of sodium dodecyl sulfate (SDS) micelles in aqueous medium calculated using the Stokes-Einstein-Sutherland equation**
| SDS Concentration | Micelle radius [nm] (Source) | Calculated micellar diffusion coefficient [cm²/s] |
| ----------------- | ---------------------------- | ------------------------------------------------- |
| SDS 0.2%          | 1.26 (Hammouda 2013[[6](#References)]) | 2.633 * 10<sup>-6</sup> |
| SDS 0.5%          | 1.26 (Clifford and Pethica 1966 + Hammouda 2013[[7](#References)]) | 1.813 * 10<sup>-6</sup> |
| *not reported*    | 1.5 (Duplatre 1996[[8](#References)]) | 2.212 * 10<sup>-6</sup> |
...
[3] [Okazaki A, Mano T, Sugano K. Theoretical dissolution model of poly-disperse drug particles in biorelevant media. J Pharm Sci. 2008 May;97(5):1843-52. doi: 10.1002/jps.21070. PMID: 17828749.](https://pubmed.ncbi.nlm.nih.gov/17828749/)

[4] [biorelevant: Product information](https://biorelevant.com)

[5] [Pepin XJH, Sanderson NJ, Blanazs A, Grover S, Ingallinera TG, Mann JC. Bridging in vitro dissolution and in vivo exposure for acalabrutinib. Part I. Mechanistic modelling of drug product dissolution to derive a P-PSD for PBPK model input. Eur J Pharm Biopharm. 2019 Sep;142:421-434. doi: 10.1016/j.ejpb.2019.07.014. Epub 2019 Jul 12. PMID: 31306753.](https://pubmed.ncbi.nlm.nih.gov/31306753/)
